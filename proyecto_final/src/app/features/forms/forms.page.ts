...
export class FormsPage {
  ...
  readonly taskForm = new FormGroup<TaskForm>({
    ...
    due_date: new FormControl<string | null>(this.draft.due_date ?? null,[Validators.required]),
  ...
  status: 'pending',
  student_id: Number(value.student_id) || null,
  due_date: value.due_date ? String(value.due_date) : null,
  };
